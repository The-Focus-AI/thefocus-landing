...
A complete fifteen-page concept based on the campaign branch `gtm/org-age-landing-pages`. All review routes are under `/preview/operations/`; existing site routes remain unchanged.
...
Pages: homepage, engagements, approach, work index, Fountain Creek case, Steering House case, anonymized media case, about, book, three chapter excerpts, book download, interactive project brief, and contact.
