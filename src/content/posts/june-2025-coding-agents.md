...
**IDE Agents**: Copilot, Cursor, RooCode
**CLI Agents**: Claude Code, Codex CLI, Aider, Goose
**Full-Stack Agents**: Codex Agent, Copilot Agent, Cursor Agent, Jules, Windsurf
**Hybrid Platforms**: v0, Warp (CLI-as-agent)
...
| -------------------------------------------------------------------------------------------------------- | ---- | --------- | --- | ----- | --------------------- | ---------------- | 
| [aider](https://aider.chat/)                                                                             | Yes  | OSS       | Yes | No    | No                    | No               | 
| [Claude Code](https://www.anthropic.com/claude-code)                                                     | No   | Anthropic | Yes | No    | No                    | No               | 
| [Codex](https://openai.com/codex/)                                                                       | No   | OpenAI    | Yes | No    | No                    | No               | 
| [Codex Agent](https://chatgpt.com/codex/onboarding)                                                      | No   | OpenAI    | No  | Yes   | Yes                   | Yes              | 
| [Copilot](https://github.com/features/copilot)                                                           | Yes  | Microsoft | No  | Yes   | No                    | No               | 
| [Copilot Agent](https://github.blog/changelog/2025-05-19-github-copilot-coding-agent-in-public-preview/) | Yes  | Microsoft | No  | No    | Yes                   | Yes              | 
| [Cursor](https://cursor.com)                                                                             | Yes* | Cursor    | No  | Yes   | No                    | No               | 
| [Cursor Agent](https://cursor.com)                                                                       | Yes* | Cursor    | No  | Yes   | Yes                   | Yes              | 
| [Goose](https://block.github.io/goose/)                                                                  | Yes  | OSS       | Yes |       | No                    |                  | 
| [Jules](https://jules.google.com/)                                                                       | No   | Google    | No  | No    | Yes                   | Yes              | 
| [RooCode](https://roocode.com/)                                                                          | Yes  | OSS       | No  | Yes   | No                    | No               | 
| [v0](https://v0.dev)                                                                                     | No   | Vercel    | No  | Yes * | No                    | No               | 
| [Warp](https://www.warp.dev/)                                                                            | Yes* | Warp      | Yes |       |                       |                  | 
| [Windsurf](https://windsurf.com/)                                                                        | Yes  | Windsurf  | No  | Yes   |                       |                  | 
...
Going into this: I personally use Cursor, RooCode, ClaudeCode and v0 the most in that order.  At the end of this evaluation, we'll see how things change!
...
The overall winner is Cursor + Warp, which gives you the best in class spectrum of the CLI tools, IDE, and background agents.

**For casual users**: The easiest one to get started with over all is v0, with a stand out both it the tightest way to iterate on designs and how easy it is to actually getting something live on the internet in the shortest possible steps.  It is strongly biased in favor of NextJS and Vercel (as it is a product of Vercel) and its ability to import an existing project is severely limited, which is major hurdle for existing teams, its the best one to start playing with.

**For product managers**: Copilot agent and Jules show the most promise, especially Copilot Agent with it's tight integration with github.  These are still rough around the edges experiences but have great potential.

**For Professionals**: Cursor as IDE and Warp as CLI.  Adding your own MCP agents to cursor is a huge productivity boost, and having Warp automate shell type tasks gives you super powers.

**For hard-core tinkerers**: RooCode and Goose give you the most control over the models and to some extent tinkering with the prompts.  While you can do some things with Cursor and Claude rules, and plugging in your own MCP servers to extend functionality, having the ability to really evaluate each model is pretty powerful.  I've managed to get RooCode to do planning and building with models running directly on my laptop, which is Freedom.

### Developer Experience

| Repo                                                                                                     | Ease         | Spark Joy                                                      | One Shot | Two Shot | SDLC Integration | Spark Joy?                                    |
| -------------------------------------------------------------------------------------------------------- | ------------ | -------------------------------------------------------------- | -------- | -------- | ---------------- | --------------------------------------------- |
| [aider](https://aider.chat/)                                                                             | Expert       | my god, seriously?!                                            | No       | No       | No               | my god, seriously?!                           |
| [Claude Code](https://www.anthropic.com/claude-code)                                                     | CLI          | Blinkenlights!                                                 | Yes*     |          | No               | Blinkenlights!                                |
| [Codex](https://openai.com/codex/)                                                                       | CLI          | Eh, sure                                                       | Yes      |          | No               | Eh, sure                                      |
| [Codex Agent](https://chatgpt.com/codex/onboarding)                                                      | Easy         | That's cool                                                    | Yes      |          | Yes              | That's cool                                   |
| [Copilot](https://github.com/features/copilot)                                                           | Professional | Stupid-face                                                    | No       | No       | No               | Stupid-face                                   |
| [Copilot Agent](https://github.blog/changelog/2025-05-19-github-copilot-coding-agent-in-public-preview/) | Professional | If this actually works it'll be game changing                  |          |          | Yes              | If this actually works it'll be game changing |
| [Cursor](https://cursor.com)                                                                             | Professional | Feel the power!                                                | Yes      |          |                  | Feel the power!                               |
| [Cursor Agent](https://cursor.com)                                                                       | Professional | Huh, that's really fascinating, didn't expect that             |          |          |                  |                                               |
| [Goose](https://block.github.io/goose/)                                                                  | CLI          | Lots of configuration                                          | Yes      |          | No               |                                               |
| [Jules](https://jules.google.com/)                                                                       | Easy         | Slick                                                          | Yes      |          | Yes              |                                               |
| [RooCode](https://roocode.com/)                                                                          | Expert       | The world is a better place because this is here               | Yes      |          | No               |                                               |
| [v0](https://v0.dev)                                                                                     | Easy         | Obviously the way to go                                        | No       | Tes      | No               | Obviously the way to go                       |
| [warp](https://www.warp.dev/)                                                                            | Professional | I'm scripting everything and never writing a bash script again | Tes      |          | No               |                                               |
| [Windsurf](https://windsurf.com/)                                                                        | Professional | I feel physically ill                                          |          |          |                  |                                               |
...
| Repo                                                                                                     | Code | Testing | Tooling | Documentation | Professional | Hire?                        | Total |
| -------------------------------------------------------------------------------------------------------- | ---- | ------- | ------- | ------------- | ------------ | ---------------------------- | ----- |
| [aider](https://aider.chat/)                                                                             | 4    | 2       | 4       | 3             | 3.5          | conditionally recommend      | 16.5  |
| [Claude Code](https://www.anthropic.com/claude-code)                                                     | 4    | 4       | 4.5     | 3             | 4            | would recommend              | 19.5  |
| [Codex](https://openai.com/codex/)                                                                       | 4    | 4       | 4       | 3             | 4            | would recommend              | 19    |
| [Codex Agent](https://chatgpt.com/codex/onboarding)                                                      | 4    | 3       | 4       | 3             | 4            | would recommend              | 18    |
| [Copilot](https://github.com/features/copilot)                                                           | 3    | 2       | 3       | 2             | 3            | conditionally recommend-face | 13    |
| [Copilot Agent](https://github.blog/changelog/2025-05-19-github-copilot-coding-agent-in-public-preview/) | 4    | 5       | 4       | 4             | 4            | strongly recommend           | 21    |
| [Cursor](https://cursor.com)                                                                             | 4    | 4       | 4       | 3.5           | 4            | would recommend              | 19.5  |
| [Cursor Agent](https://cursor.com)                                                                       | 5    | 5       | 5       | 4             | 5            | strongly recommend           | 24    |
| [Goose](https://block.github.io/goose/)                                                                  | 4    | 4       | 4       | 3.5           | 4            | would recommend              | 19.5  |
| [Jules](https://jules.google.com/)                                                                       | 4    | 5       | 4       | 4             | 4            | strongly recommend           | 21    |
| [RooCode](https://roocode.com/)                                                                          | 4    | 4.5     | 4       | 3             | 4            | strongly recommend           | 19.6  |
| [v0](https://v0.dev)                                                                                     | 5    | 4       | 5       | 5             | 5            | strongly recommend           | 24    |
| [warp](https://www.warp.dev/)                                                                            | 4    | 5       | 5       | 5             | 5            | strongly recommend           | 24    |
| [Windsurf](https://windsurf.com/)                                                                        | 3    | 2       | 3       | 2             | 3            | conditionally recommend      | 13    |
